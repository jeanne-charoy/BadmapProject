...
```{r}
##trials that don't make sense

##eliminating trials where RTs were higher than 5000ms or lower than 200ms
nounTask<-nounTask[!nounTask$rt > 5000,]
nounTask<-nounTask[!nounTask$rt <200,]

idTask<-idTask[!idTask$rt > 5000,]
idTask<-idTask[!idTask$rt < 200,]
```
...
#aggregate(sAnswer ~ condition, idTask_good, FUN="mean")
